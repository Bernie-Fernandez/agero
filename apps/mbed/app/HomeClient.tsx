  ...
  return (
    <section id="portfolio" className="bg-charcoal py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          {/* Hero — spans rows 1+2 */}
          <Link href="/projects/dental-fitout-canterbury" className="portfolio-item relative block" style={{ gridColumn: "1", gridRow: "1 / span 2" }}>
            <Image
              src="/images/imgco-11.jpg"
          ...
          {/* imgco-16 — top right */}
          <Link href="/projects/specialist-centre-north-preston" className="portfolio-item relative block" style={{ gridColumn: "2 / span 2", gridRow: "1" }}>
            <Image
