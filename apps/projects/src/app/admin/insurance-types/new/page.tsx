...
export default async function NewInsuranceTypePage({
  searchParams,
}: {
  ...
  return (
    <div className="max-w-md">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-zinc-900 mt-2">Add Insurance Type</h1>
      </div>
      ...
      <form action={createInsuranceType} className="space-y-4 bg-white border border-gray-200 rounded-lg p-6">
        <div>
