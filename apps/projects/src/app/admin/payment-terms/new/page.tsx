  ...
  return (
    <div className="max-w-md">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-zinc-900 mt-2">Add Payment Term</h1>
      </div>
      ...
      <form action={createPaymentTerm} className="space-y-4 bg-white border border-gray-200 rounded-lg p-6">
        <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-1">Set as Default?</label>
            <select
              name="isDefault"
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              <option value="false">No</option>
              <option value="true">Yes (replaces current default)</option>
            </select>
          </div>
          <div>
